<template>
	<view class="swiperContent">
		...
		:class="(swiperType && displayMultipleItems ==1 && !vertical)?'cardSwiper':'' "
		:swiperList = "swiperList"
		class="screen-swiper"
		>
			<swiper-item class="swiper-item"  v-for="(item,index) in swiperList" :key="index" :class="(cardCur==index && displayMultipleItems ==1 && !vertical)?'cur':''"  @tap="clickItem(index)">
