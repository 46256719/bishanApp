...
var _default = { data: function data() {return { pollution: {} };}, mounted: function mounted() {var _this2 = this;uni.$on("showDetail", function (pollution) {_this2.pollution = pollution;});},
  methods: {
    ...
    toNavigation: function toNavigation() {//导航
      var _this = this;
      // 判断平台  
      var wgs84togcj02 = _mapTool.mapTool.wgs84togcj02(_this.pollution.longitude, _this.pollution.latitude);
